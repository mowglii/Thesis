...
<div data-role="page" data-theme="a">      
    ...
    <div data-role="content" class="graph" >
        <div class="header-graph">
            <div data-role="controlgroup" data-type="horizontal">
                <a href="graphweek.php" data-role="button"  data-ajax="false">Week</a>
                <a href="graphmonth.php" data-role="button" class="no-active"  data-ajax="false">Month</a>
            </div>
        </div>
        <div style="width:100%; margin-top:1em; padding-bottom:2em;" >
